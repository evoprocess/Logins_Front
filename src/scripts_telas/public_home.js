    ...
    <div class="public-page">
      ...
      <main>
        ...
        <section id="planos" class="plans-section public-screen" data-public-screen>
          <div class="plans-heading"><span class="public-eyebrow">PLANOS GATEGUARD</span><h2>Escolha o nível de gestão ideal</h2><p>Comece com cobranças avulsas, adicione clientes e controle de acesso ou integre toda a operação ao GateGuard.</p></div>
          <div class="plans-grid">
            <article class="plan-card"><span class="plan-level">BÁSICO</span><div class="plan-rating" aria-label="3 de 5 estrelas"><span>★★★</span><i>★★</i></div><h3>Pagamentos Avulsos</h3><p>Emita cobranças avulsas sem cadastro, login ou relacionamento com clientes.</p><ul><li>API de pagamento online</li><li>Emissão de faturas avulsas</li><li>Histórico financeiro</li><li>Sem banco de dados oferecido à organização</li><li>Taxa GateGuard de R$ 0,50 por transação</li></ul><a href="${contactLink}" class="plan-contact">Consultar valor</a></article>
            <article class="plan-card is-featured"><b class="recommended-badge">MAIS RECOMENDADO</b><span class="plan-level">PROFISSIONAL</span><div class="plan-rating" aria-label="4 de 5 estrelas"><span>★★★★</span><i>★</i></div><h3>Pagamentos Avulsos e de Clientes</h3><p>Cadastre clientes, emita faturas direcionadas e gerencie o acesso de cada cliente conforme sua situação de pagamento.</p><ul><li>Pagamentos e faturas avulsas</li><li>Banco de dados da organização</li><li>Cadastro e autenticação de clientes com Firebase Auth</li><li>Faturas e histórico por cliente</li><li>Ativação e desativação do login conforme o pagamento</li><li>Taxa GateGuard de R$ 0,50 por transação</li></ul><a href="${contactLink}" class="plan-contact">Consultar valor</a></article>
            <article class="plan-card"><span class="plan-level">PERSONALIZADO</span><div class="plan-rating" aria-label="5 de 5 estrelas"><span>★★★★★</span></div><h3>Pagamentos Avulsos e de Clientes e Controle de Acessos Operacionais</h3><p>Sistema completo, com bancos de pagamentos, acessos e operação. Seu site é desenvolvido pela nossa equipe e integrado ao GateGuard.</p><ul><li>Tudo do Plano Profissional</li><li>Banco de dados operacional</li><li>Níveis de perfil e hierarquia de acessos</li><li>Desenvolvimento de frontend e backend</li><li>Integração completa ao GateGuard</li><li>Taxa GateGuard de R$ 0,50 por transação</li></ul><a href="${contactLink}" class="plan-contact">Consultar valor</a></article>
          </div>
          <button type="button" id="compare-plans-button" class="compare-plans-button">Comparar Planos</button>
          <p class="plans-pricing-note">Todos os planos possuem uma taxa GateGuard de R$ 0,50 por transação, acrescida às tarifas cobradas pelo Asaas. Os demais valores são definidos conforme o porte, o volume e as necessidades de cada sistema.</p>
          <dialog id="plans-comparison-modal" class="plans-comparison-modal" aria-labelledby="plans-comparison-title"><div class="plans-comparison"><button type="button" id="close-plans-comparison" class="plans-modal-close" aria-label="Fechar comparação">&times;</button><h3 id="plans-comparison-title">Comparação dos planos</h3><div class="plans-table-wrap"><table><thead><tr><th>Funcionalidade</th><th>Básico</th><th>Profissional</th><th>Personalizado</th></tr></thead><tbody><tr><td>API de pagamentos e faturas avulsas</td><td>✓</td><td>✓</td><td>✓</td></tr><tr><td>Taxa GateGuard de R$ 0,50 por transação</td><td>✓</td><td>✓</td><td>✓</td></tr><tr><td>Banco de dados oferecido à organização</td><td>—</td><td>✓</td><td>✓</td></tr><tr><td>Cadastro e autenticação de clientes</td><td>—</td><td>✓</td><td>✓</td></tr><tr><td>Faturas direcionadas a clientes</td><td>—</td><td>✓</td><td>✓</td></tr><tr><td>Gestão do login conforme o pagamento</td><td>—</td><td>✓</td><td>✓</td></tr><tr><td>Banco de dados operacional</td><td>—</td><td>—</td><td>✓</td></tr><tr><td>Perfis e hierarquia de acessos</td><td>—</td><td>—</td><td>✓</td></tr><tr><td>Frontend e backend completos</td><td>—</td><td>—</td><td>✓</td></tr></tbody></table></div><p>A taxa GateGuard é adicional às tarifas do Asaas. Entre em contato para receber uma proposta adequada ao seu sistema.</p></div></dialog>
        </section>
        ...
        <section id="como-funciona" class="responsibilities-section public-screen" data-public-screen>
          ...
          <div class="responsibilities-grid">
            <article><span>G</span><h3>O GateGuard cuida</h3><ul><li>Cobranças avulsas em todos os planos</li><li>Banco de dados, clientes e autenticação a partir do Profissional</li><li>Banco operacional e sistema completo no Personalizado</li></ul></article>
            <article><span>O</span><h3>Sua organização mantém</h3><ul><li>Autonomia sobre o próprio negócio</li><li>Seus dados operacionais nos planos Básico e Profissional</li><li>Uma experiência integrada para seus usuários</li></ul></article>
          </div>

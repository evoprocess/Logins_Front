      ...
      <main>
        ...
        <section id="planos" class="plans-section public-screen" data-public-screen>
          ...
          <div class="plans-grid">
            <article class="plan-card"><span class="plan-level">BÁSICO</span><div class="plan-rating" aria-label="3 de 5 estrelas"><span>★★★</span><i>★★</i></div><h3>Pagamentos</h3><p>Banco de dados exclusivo para os pagamentos da organização, sem login ou relacionamento com clientes cadastrados.</p><ul><li>API de pagamento online e faturas</li><li>Histórico financeiro</li><li>Banco de dados com coleção de pagamentos</li><li>Pagamentos avulsos</li></ul><a href="${contactLink}" class="plan-contact">Consultar valor</a></article>
            <article class="plan-card is-featured"><b class="recommended-badge">MAIS RECOMENDADO</b><span class="plan-level">PROFISSIONAL</span><div class="plan-rating" aria-label="4 de 5 estrelas"><span>★★★★</span><i>★</i></div><h3>Pagamentos e Acessos</h3><p>Banco de dados de pagamentos e acessos para controlar clientes e logins da organização.</p><ul><li>API de pagamento online e faturas avulsas</li><li>Banco de dados com coleção de pagamentos</li><li>Banco de dados com coleção de acessos</li><li>Ativação e desativação de logins</li><li>Pagamentos avulsos e de clientes cadastrados</li></ul><a href="${contactLink}" class="plan-contact">Consultar valor</a></article>

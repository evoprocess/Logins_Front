    ...
    <div class="public-page">
      ...
      <main>
        ...
        <section id="planos" class="plans-section public-screen" data-public-screen>
          <div class="plans-heading"><span class="public-eyebrow">PLANOS GATEGUARD</span><h2>Escolha o nível de gestão ideal</h2><p>Em todos os planos, o GateGuard gerencia o banco de dados contratado: comece pelos pagamentos, inclua acessos ou integre toda a operação.</p></div>
          <div class="plans-grid">
            <article class="plan-card"><span class="plan-level">BÁSICO</span><div class="plan-rating" aria-label="3 de 5 estrelas"><span>★★★</span><i>★★</i></div><h3>Pagamentos Avulsos</h3><p>Banco de dados exclusivo para os pagamentos da organização, sem login ou relacionamento com clientes cadastrados.</p><ul><li>API de pagamento online e faturas</li><li>Histórico financeiro</li><li>Banco de dados com coleção de pagamentos</li><li>Pagamentos avulsos</li></ul><a href="${contactLink}" class="plan-contact">Consultar valor</a></article>
            <article class="plan-card is-featured"><b class="recommended-badge">MAIS RECOMENDADO</b><span class="plan-level">PROFISSIONAL</span><div class="plan-rating" aria-label="4 de 5 estrelas"><span>★★★★</span><i>★</i></div><h3>Pagamentos Avulsos e de Clientes</h3><p>Receba pagamentos avulsos ou cadastre clientes para emitir faturas direcionadas e acompanhar cada pagamento individualmente.</p><ul><li>API de pagamento online</li><li>Emissão de faturas avulsas</li><li>Cadastro e autenticação de clientes</li><li>Faturas direcionadas a clientes cadastrados</li><li>Coleções de pagamentos e acessos</li><li>Histórico de pagamentos por cliente</li><li>Ativação e desativação de logins</li></ul><a href="${contactLink}" class="plan-contact">Consultar valor</a></article>
            <article class="plan-card"><span class="plan-level">PERSONALIZADO</span><div class="plan-rating" aria-label="5 de 5 estrelas"><span>★★★★★</span></div><h3>Pagamentos, Acessos e Operacional</h3><p>Sistema completo, com banco de dados de pagamento, acessos e operacional. Seu site totalmente construido pela nossa equipe e integrado ao GateGuard.</p><ul><li>API de pagamento online e faturas</li><li>Histórico financeiro</li><li>Coleções de pagamentos, acessos e produção</li><li>Ativação e desativação de logins</li><li>Níveis de perfil e hierarquia de acessos</li><li>Desenvolvimento de frontend e backend</li></ul><a href="${contactLink}" class="plan-contact">Consultar valor</a></article>
          </div>
          ...
          <dialog id="plans-comparison-modal" class="plans-comparison-modal" aria-labelledby="plans-comparison-title"><div class="plans-comparison"><button type="button" id="close-plans-comparison" class="plans-modal-close" aria-label="Fechar comparação">&times;</button><h3 id="plans-comparison-title">Comparação dos planos</h3><div class="plans-table-wrap"><table><thead><tr><th>Funcionalidade</th><th>Básico</th><th>Profissional</th><th>Personalizado</th></tr></thead><tbody><tr><td>API de pagamentos e faturas avulsas</td><td>✓</td><td>✓</td><td>✓</td></tr><tr><td>Coleção de pagamentos</td><td>✓</td><td>✓</td><td>✓</td></tr><tr><td>Pagamentos sem vínculo com clientes</td><td>✓</td><td>✓</td><td>✓</td></tr><tr><td>Cadastro e autenticação de clientes</td><td>—</td><td>✓</td><td>✓</td></tr><tr><td>Faturas direcionadas a clientes</td><td>—</td><td>✓</td><td>✓</td></tr><tr><td>Histórico de pagamentos por cliente</td><td>—</td><td>✓</td><td>✓</td></tr><tr><td>Coleção de produção e banco operacional</td><td>—</td><td>—</td><td>✓</td></tr><tr><td>Perfis e hierarquia de acessos</td><td>—</td><td>—</td><td>✓</td></tr><tr><td>Frontend e backend completos</td><td>—</td><td>—</td><td>✓</td></tr></tbody></table></div><p>Entre em contato para receber uma proposta adequada ao seu sistema.</p></div></dialog>
        </section>
        ...
        <section id="como-funciona" class="responsibilities-section public-screen" data-public-screen>
          ...
          <div class="responsibilities-grid">
            <article><span>G</span><h3>O GateGuard cuida</h3><ul><li>Banco de pagamentos em todos os planos</li><li>Banco de acessos e autenticação a partir do Profissional</li><li>Banco operacional e sistema completo no Personalizado</li></ul></article>

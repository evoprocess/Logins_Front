      ...
      <main>
        ...
        <section id="planos" class="plans-section public-screen" data-public-screen>
          ...
          <div class="plans-grid">
            <article class="plan-card"><h3>API de Pagamentos</h3><p>Gestão de cobranças e autenticação de clientes com acesso vinculado à situação financeira.</p><ul><li>Pagamentos e faturas avulsas ou por cliente</li><li>Cadastro e autenticação de clientes</li><li>Histórico financeiro por cliente</li><li>Status ativo ou inativo do login</li><li>Acesso condicionado ao pagamento quando aplicável</li><li>Compatível com bancos SQL e NoSQL</li></ul><a href="${contactLink}" class="plan-contact">Consultar valor</a></article>
            <article class="plan-card"><h3>API de Acessos</h3><p>Autenticação de usuários e identificação do perfil e nível para uso no sistema da organização.</p><ul><li>Autenticação centralizada de usuários</li><li>Status ativo ou inativo do login</li><li>Perfis: admin, gerente, supervisor e operador</li><li>Dois níveis de acesso para cada perfil</li><li>API de validação de perfil e nível</li><li>A organização define as permissões das 8 combinações</li><li>Compatível com bancos SQL e NoSQL</li></ul><a href="${contactLink}" class="plan-contact">Consultar valor</a></article>
          ...
          <dialog id="plans-comparison-modal" class="plans-comparison-modal" aria-labelledby="plans-comparison-title"><div class="plans-comparison"><button type="button" id="close-plans-comparison" class="plans-modal-close" aria-label="Fechar comparação">&times;</button><h3 id="plans-comparison-title">Comparação dos planos</h3><div class="plans-table-wrap"><table><thead><tr><th>Funcionalidade</th><th>API de Pagamentos</th><th>API de Acessos</th><th>Plus</th><th>Segurança Avançada<br><small>Em breve</small></th></tr></thead><tbody><tr><td>Pagamentos e faturas</td><td>✓</td><td>—</td><td>✓</td><td>—</td></tr><tr><td>Login vinculado à situação financeira</td><td>✓</td><td>—</td><td>✓</td><td>—</td></tr><tr><td>Autenticação de usuários operacionais</td><td>—</td><td>✓</td><td>✓</td><td>✓</td></tr><tr><td>Status ativo ou inativo do login</td><td>✓</td><td>✓</td><td>✓</td><td>✓</td></tr><tr><td>Perfis admin, gerente, supervisor e operador</td><td>—</td><td>✓</td><td>✓</td><td>✓</td></tr><tr><td>Dois níveis para cada perfil</td><td>—</td><td>✓</td><td>✓</td><td>✓</td></tr><tr><td>API de validação de perfil e nível</td><td>—</td><td>✓</td><td>✓</td><td>✓</td></tr><tr><td>Pagamentos e acessos integrados</td><td>—</td><td>—</td><td>✓</td><td>—</td></tr><tr><td>MFA, biometria e reconhecimento facial</td><td>—</td><td>—</td><td>—</td><td>Em breve</td></tr><tr><td>Compatível com bancos SQL e NoSQL</td><td>✓</td><td>✓</td><td>✓</td><td>✓</td></tr></tbody></table></div><p>O GateGuard autentica o usuário e informa seu perfil e nível. A organização determina as permissões de cada uma das 8 combinações e mantém seu próprio sistema e banco de dados. Os recursos de Segurança Avançada ainda estão em desenvolvimento.</p></div></dialog>
        </section>
        ...
        <section id="como-funciona" class="responsibilities-section public-screen" data-public-screen>
          ...
          <p class="responsibilities-limit"><strong>Responsabilidades bem definidas:</strong> o GateGuard confirma quem entrou e informa perfil e nível; a organização determina o que cada uma das 8 combinações pode acessar.</p>
        </section>

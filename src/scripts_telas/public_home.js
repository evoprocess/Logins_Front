    ...
    <div class="public-page">
      ...
      <main>
        ...
        <section id="planos" class="plans-section public-screen" data-public-screen>
          <div class="plans-heading"><span class="public-eyebrow">PLANOS GATEGUARD</span><h2>Escolha o banco que o GateGuard vai gerir</h2><p>Estruture pagamentos ou processos operacionais com acessos vinculados a cada finalidade — ou reúna os dois no Plano Plus.</p></div>
          <div class="plans-grid">
            <article class="plan-card"><h3>Pagamentos e Acessos</h3><p>Banco de pagamentos com logins vinculados à situação financeira de cada cliente.</p><ul><li>Banco de dados de pagamentos construído e gerido pelo GateGuard</li><li>Backend e API de pagamentos</li><li>Pagamentos e faturas avulsas ou por cliente</li><li>Cadastro e autenticação de clientes</li><li>Histórico financeiro por cliente</li><li>Ativação e desativação do login conforme o pagamento</li></ul><a href="${contactLink}" class="plan-contact">Consultar valor</a></article>
            <article class="plan-card"><h3>Operacional e Acessos</h3><p>Banco operacional com logins vinculados aos processos e registros da organização.</p><ul><li>Banco de dados operacional construído e gerido pelo GateGuard</li><li>Backend e API operacional</li><li>Autenticação de usuários</li><li>Acessos associados aos processos operacionais</li><li>Perfis e permissões conforme a função do usuário</li><li>Ativação e desativação de logins operacionais</li></ul><a href="${contactLink}" class="plan-contact">Consultar valor</a></article>
            <article class="plan-card is-featured"><b class="recommended-badge">PLANO PLUS</b><h3>Pagamentos, Operacional e Acessos</h3><p>Os dois ambientes reunidos: gestão financeira e operação conectadas por acessos com finalidade definida.</p><ul><li>Banco de dados de pagamentos e respectivo backend</li><li>Banco de dados operacional e respectivo backend</li><li>APIs de pagamentos e processos operacionais</li><li>Faturas avulsas e por cliente</li><li>Logins vinculados a pagamentos ou à operação</li><li>Integração completa entre os dois ambientes</li></ul><a href="${contactLink}" class="plan-contact">Consultar valor</a></article>
          </div>
          ...
          <dialog id="plans-comparison-modal" class="plans-comparison-modal" aria-labelledby="plans-comparison-title"><div class="plans-comparison"><button type="button" id="close-plans-comparison" class="plans-modal-close" aria-label="Fechar comparação">&times;</button><h3 id="plans-comparison-title">Comparação dos planos</h3><div class="plans-table-wrap"><table><thead><tr><th>Funcionalidade</th><th>Pagamentos e Acessos</th><th>Operacional e Acessos</th><th>Plus</th></tr></thead><tbody><tr><td>Banco de dados de pagamentos</td><td>✓</td><td>—</td><td>✓</td></tr><tr><td>Backend e API de pagamentos</td><td>✓</td><td>—</td><td>✓</td></tr><tr><td>Faturas avulsas e por cliente</td><td>✓</td><td>—</td><td>✓</td></tr><tr><td>Login vinculado à situação financeira</td><td>✓</td><td>—</td><td>✓</td></tr><tr><td>Banco de dados operacional</td><td>—</td><td>✓</td><td>✓</td></tr><tr><td>Backend e API operacional</td><td>—</td><td>✓</td><td>✓</td></tr><tr><td>Login vinculado a processos operacionais</td><td>—</td><td>✓</td><td>✓</td></tr><tr><td>Integração entre pagamentos e operação</td><td>—</td><td>—</td><td>✓</td></tr><tr><td>Desenvolvimento de frontend</td><td>—</td><td>—</td><td>—</td></tr></tbody></table></div><p>O GateGuard constrói e gerencia os bancos e backends contratados. O frontend permanece sob responsabilidade da organização.</p></div></dialog>
        </section>

        <section id="como-funciona" class="responsibilities-section public-screen" data-public-screen>
          <div class="responsibilities-heading"><span class="public-eyebrow">SIMPLES, SEGURO E SOB MEDIDA</span><h2>Como funciona o GateGuard?</h2><p>Escolha o ambiente que deseja estruturar. O GateGuard constrói e gerencia o banco, o backend e os acessos relacionados aos processos contratados.</p></div>
          <div class="how-steps"><article><span>1</span><h3>Escolha seu ambiente</h3><p>Contrate pagamentos, operação ou os dois ambientes reunidos no Plano Plus.</p></article><article><span>2</span><h3>Integre seu frontend</h3><p>Sua organização mantém a experiência visual enquanto se conecta aos backends e às APIs do GateGuard.</p></article><article><span>3</span><h3>Controle cada acesso</h3><p>Todo login fica associado a uma finalidade financeira ou operacional claramente definida.</p></article></div>
          <div class="responsibilities-grid">
            <article><span>G</span><h3>O GateGuard cuida</h3><ul><li>Construção e gestão dos bancos contratados</li><li>Backends, APIs e autenticação</li><li>Regras de acesso ligadas a pagamentos ou à operação</li></ul></article>
            <article><span>O</span><h3>Sua organização mantém</h3><ul><li>Autonomia sobre o próprio negócio</li><li>Desenvolvimento e identidade do frontend</li><li>Uma experiência integrada para seus usuários</li></ul></article>
          </div>
          <p class="responsibilities-limit"><strong>Todo acesso possui uma finalidade:</strong> controlar a situação financeira, participar de um processo operacional ou atuar nos dois ambientes com o Plano Plus.</p>
        </section>

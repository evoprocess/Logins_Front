  ...
  <section class="form-section developer-internal-manual">
    <details>
      ...
      <ol>
        ...
        <li>O mesmo usuário <code>sis_XXXX-gestor@sislogin.com.br</code> e a mesma senha do login geral devem existir no Firebase Authentication central e no Firebase Authentication do sistema.</li>

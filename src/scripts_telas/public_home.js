      ...
      <main>
        ...
        <section id="planos" class="plans-section public-screen" data-public-screen>
          ...
          <div class="plans-grid">
            ...
            <article class="plan-card is-featured"><b class="recommended-badge">MAIS RECOMENDADO</b><span class="plan-level">PROFISSIONAL</span><div class="plan-rating" aria-label="4 de 5 estrelas"><span>★★★★</span><i>★</i></div><h3>Pagamentos Avulsos e de Clientes</h3><p>Banco de dados de pagamentos e acessos para controlar clientes e logins da organização.</p><ul><li>API de pagamento online e faturas avulsas</li><li>Banco de dados com coleção de pagamentos</li><li>Banco de dados com coleção de acessos</li><li>Ativação e desativação de logins</li><li>Pagamentos avulsos e de clientes cadastrados</li></ul><a href="${contactLink}" class="plan-contact">Consultar valor</a></article>
          ...
          <dialog id="plans-comparison-modal" class="plans-comparison-modal" aria-labelledby="plans-comparison-title"><div class="plans-comparison"><button type="button" id="close-plans-comparison" class="plans-modal-close" aria-label="Fechar comparação">&times;</button><h3 id="plans-comparison-title">Comparação dos planos</h3><div class="plans-table-wrap"><table><thead><tr><th>Funcionalidade</th><th>Básico</th><th>Profissional</th><th>Personalizado</th></tr></thead><tbody><tr><td>API de pagamentos e faturas</td><td>✓</td><td>✓</td><td>✓</td></tr><tr><td>Coleção de pagamentos</td><td>✓</td><td>✓</td><td>✓</td></tr><tr><td>Pagamentos avulsos</td><td>✓</td><td>✓</td><td>✓</td></tr><tr><td>Coleção de acessos e Firebase Auth</td><td>—</td><td>✓</td><td>✓</td></tr><tr><td>Clientes cadastrados e controle de logins</td><td>—</td><td>✓</td><td>✓</td></tr><tr><td>Coleção de produção e banco operacional</td><td>—</td><td>—</td><td>✓</td></tr><tr><td>Perfis e hierarquia de acessos</td><td>—</td><td>—</td><td>✓</td></tr><tr><td>Frontend e backend completos</td><td>—</td><td>—</td><td>✓</td></tr></tbody></table></div><p>Entre em contato para receber uma proposta adequada ao seu sistema.</p></div></dialog>
        </section>

      ...
      <main>
        ...
        <section id="planos" class="plans-section public-screen" data-public-screen>
          ...
          <div class="plans-grid">
            <article class="plan-card"><span class="plan-level">BÁSICO</span><div class="plan-rating" aria-label="3 de 5 estrelas"><span>★★★</span><i>★★</i></div><h3>Gestão de Pagamentos</h3><p>Banco Firebase exclusivo para os pagamentos da organização, sem login ou relacionamento com clientes cadastrados.</p><ul><li>API de pagamento online e faturas</li><li>Histórico financeiro</li><li>Banco de dados com coleção de pagamentos</li><li>Pagamentos avulsos</li></ul><a href="${contactLink}" class="plan-contact">Consultar valor</a></article>
            <article class="plan-card is-featured"><b class="recommended-badge">MAIS RECOMENDADO</b><span class="plan-level">PROFISSIONAL</span><div class="plan-rating" aria-label="4 de 5 estrelas"><span>★★★★</span><i>★</i></div><h3>Gestão de Pagamentos e Acessos</h3><p>Banco Firebase de pagamentos e acessos com Firebase Auth para controlar clientes e logins da organização.</p><ul><li>API de pagamento online e faturas avulsas</li><li>Banco de dados com coleção de pagamentos</li><li>Banco de dados com coleção de acessos</li><li>Ativação e desativação de logins</li><li>Pagamentos avulsos e de clientes cadastrados</li></ul><a href="${contactLink}" class="plan-contact">Consultar valor</a></article>
            <article class="plan-card"><span class="plan-level">PERSONALIZADO</span><div class="plan-rating" aria-label="5 de 5 estrelas"><span>★★★★★</span></div><h3>Gestão de Pagamentos, Acessos e Operacional</h3><p>Sistema completo, com pagamentos, clientes, acessos e operação integrados ao GateGuard.</p><ul><li>API de pagamento online e faturas</li><li>Histórico financeiro</li><li>Coleções de pagamentos, acessos e produção</li><li>Ativação e desativação de logins</li><li>Níveis de perfil e hierarquia de acessos</li><li>Desenvolvimento de frontend e backend</li></ul><a href="${contactLink}" class="plan-contact">Consultar valor</a></article>
          </div>
